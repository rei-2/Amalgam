		...
		if (BeginTable("CompTable", 2))
		{
			...
			TableNextColumn();
			{
				...
				if (Section("Ammo Tracker"))
				{
					...
					FToggle(Vars::Competitive::AmmoTracker::ShowHudOverlay, FToggleEnum::Right);
			...
			TableNextColumn();
			{
				...
				if (Section("Uber Tracker"))
				{
					...
					FSlider(Vars::Competitive::UberTracker::MedDeathDuration, FSliderEnum::Left);
					FSlider(Vars::Competitive::UberTracker::BoxFontSize, FSliderEnum::Right);
					FSlider(Vars::Competitive::UberTracker::BoxX, FSliderEnum::Left);
					FSlider(Vars::Competitive::UberTracker::BoxY, FSliderEnum::Right);
					FSlider(Vars::Competitive::UberTracker::BoxWidth, FSliderEnum::Left);
					FSlider(Vars::Competitive::UberTracker::AdvantageFontSize, FSliderEnum::Right);
					FSlider(Vars::Competitive::UberTracker::AdvantageX, FSliderEnum::Left);
					FSlider(Vars::Competitive::UberTracker::AdvantageY, FSliderEnum::Right);
					FSlider(Vars::Competitive::UberTracker::EvenThresholdRange, FSliderEnum::Left);
					FSlider(Vars::Competitive::UberTracker::MidUberThreshold, FSliderEnum::Right);
					FSlider(Vars::Competitive::UberTracker::HighUberThreshold, FSliderEnum::Left);
				...
				if (Section("Sticky ESP"))
				{
					...
					FToggle(Vars::Competitive::StickyESP::EnemyOnly, FToggleEnum::Left);
				...
				if (Section("Crit Heals"))
				{
					...
					FSlider(Vars::Competitive::CritHeals::CritHealTime, FSliderEnum::Left);
					FSlider(Vars::Competitive::CritHeals::MaxOverhealMultiplier, FSliderEnum::Right);
					FSlider(Vars::Competitive::CritHeals::UberPenaltyThreshold, FSliderEnum::Left);
					FSlider(Vars::Competitive::CritHeals::BuffThreshold, FSliderEnum::Right);
					FSlider(Vars::Competitive::CritHeals::BuffFadeThreshold, FSliderEnum::Left);
				...
				if (Section("Focus Fire"))
				{
					...
					FSlider(Vars::Competitive::FocusFire::BoxThickness, FSliderEnum::Left);
					FSlider(Vars::Competitive::FocusFire::BoxPadding, FSliderEnum::Right);
					FSlider(Vars::Competitive::FocusFire::CornerLength, FSliderEnum::Left);
					FToggle(Vars::Competitive::FocusFire::EnableChams, FToggleEnum::Right);
					FToggle(Vars::Competitive::FocusFire::EnableBox, FToggleEnum::Left);
					...
					Dummy({ 0, H::Draw.Scale(4) }); // Add spacing before color picker
					FColorPicker(Vars::Competitive::FocusFire::Color, FColorPickerEnum::Left);
				} EndSection();
			}
