...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginMenu(const char* label, bool enabled = true, bool arrow = true);   // create a sub-menu entry. only call EndMenu() if this returns true!
...
enum ImGuiInputTextFlags_
{
	...
	ImGuiInputTextFlags_NoKeyboardNavigate  = 1 << 25,   // Pressing TAB no focuss..
